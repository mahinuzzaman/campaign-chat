...
class CampaignGenerator:
    ...
    def generate_campaign(
        self, message: str, connected_sources: List[str]
    ) -> Dict[str, Any]:
    ...
    def _generate_audience(self, intent: str, sources: List[str]) -> Dict[str, Any]:
        ...
        audience_templates = {
            "cart_abandonment": {
                ...
                "demographics": {"age": "25-34", "gender": "female", "location": "US"},
            },
            "retargeting": {
                "segment": "website_visitors_engaged",
                "size": (
                    random.randint(800, 1500) if "google_ads" in sources else base_size
                ),
                "demographics": {
                    "age": "25-44",
                    "gender": "mixed",
            ...
            "product_promotion": {
                ...
                "demographics": {"age": "25-44", "gender": "female", "location": "US"},
            },
            "brand_awareness": {
    ...
    def _generate_messages(
        self, intent: str, channels: Dict[str, Any], audience: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        message_templates = {
            ...
            "retargeting": {
                ...
                "push": {"content": "New arrivals based on your interests are here!"},
            },
            "product_promotion": {
                "email": {
                ...
                "push": {"content": "🆕 New Winter Collection is live! Shop now"},
            },
            "brand_awareness": {
                "email": {
        ...
        base_messages = message_templates.get(
            intent, message_templates["product_promotion"]
        )
        result = {}
    ...
    def _calculate_timing(self, intent: str, sources: List[str]) -> Dict[str, str]:
        ...
        if send_time.hour < 19:
            ...
            send_time = send_time.replace(hour=19, minute=0, second=0) + timedelta(
                days=1
            )
    ...
    def _estimate_performance(
        self, audience: Dict[str, Any], channels: Dict[str, Any]
    ) -> Dict[str, float]:
        ...
        return {
            "reach": audience["size"],
            "open_rate": round(
                rates["open"] * random.uniform(1 - variation, 1 + variation), 3
            ),
            "click_rate": round(
                rates["click"] * random.uniform(1 - variation, 1 + variation), 3
            ),
            "conversion_rate": round(
                rates["conversion"] * random.uniform(1 - variation, 1 + variation), 3
            ),
        }
    ...
    def generate_response_text(
        self, campaign: Dict[str, Any], user_message: str
    ) -> str:
        ...
        base_response = responses.get(
            intent,
            f"I've generated a {intent} campaign targeting {audience_size} users via {primary_channel} with {int(confidence*100)}% confidence.",
        )
